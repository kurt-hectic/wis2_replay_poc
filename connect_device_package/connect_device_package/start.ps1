...
& $python3 aws-iot-device-sdk-python-v2\samples\pubsub.py --endpoint awyxyfhut1ugd-ats.iot.eu-central-1.amazonaws.com --ca_file root-CA.crt --cert replay-thing-2.cert.pem --key replay-thing-2.private.key --client_id basicPubSub --topic sdk/test/python --count 0